<?php
/* Smarty version 3.1.33, created on 2019-07-21 13:25:12
  from '/home1/agnald39/outletducao/view/termos_e_condicoes.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d3491e8715748_72622752',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '09a1d067fa096008647a88c5abc841fa67eb7d10' => 
    array (
      0 => '/home1/agnald39/outletducao/view/termos_e_condicoes.tpl',
      1 => 1556058986,
      2 => 'file',
    ),
  ),
...
function content_5d3491e8715748_72622752 (Smarty_Internal_Template $_smarty_tpl) {
?><style>
    #overflowTest {
...
<div class="container ">
    <div id="overflowTest" class="">
        ...
        <b>VISÃO GERAL</b>
        <br><br>
        Esse site é operado pelo Outlet Du Cão. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Outlet Du Cão. O Outlet Du Cão proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.<br><br>
        ...
        Nossa loja é hospedada no Shopify Inc. Eles nos fornecem uma plataforma de e-commerce online que nos permite vender nossos produtos e serviços.<br><br>
        <br><br>
        ...
        Fizemos todo o esforço possível da forma mais precisa as cores e imagens dos nossos produtos que aparecem na loja. Não podemos garantir que a exibição de qualquer cor no monitor do seu computador será precisa.<br><br>
        <br>
        ...
        Para mais detalhes, por favor, revise nossa Política de devolução.<br><br>
        <br><br>
        ...
        Não assumimos nenhuma obrigação de atualizar, alterar ou esclarecer informações no Serviço ou em qualquer site relacionado, incluindo, sem limitação, a informações sobre preços, exceto conforme exigido por lei. Nenhuma atualização específica ou data de atualização no Serviço ou em qualquer site relacionado, deve ser utilizada para indicar que todas as informações do Serviço ou em qualquer site relacionado tenham sido modificadas ou atualizadas.<br><br>
        <br><br>
        ...
        <br><br>
        As perguntas sobre os Termos de serviço devem ser enviadas para nós através do outletducao@gmail.com.<br><br>
    </div>
</div>
<br><br><?php }
}
