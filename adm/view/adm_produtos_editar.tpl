...
<section class="row" id="camposproduto">
    ...
    <form name="frm_produto" method="post" action=""  enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            <label>Produto</label>
            <input type="text" name="pro_nome" id="pro_nome" maxlength="40" class="form-control"  required value="{$PRO.1.pro_nome}">
        ...
        <div class="col-md-2">
         ...
         <div class="col-md-12">
             <center>
       <picture><img src="{$GET_SITE_HOME}/media/images/calculo.jpg" alt=""  /></picture>
         </center>
         </div>
